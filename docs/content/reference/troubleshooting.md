...
Most of these come down to network reality or how npmjs serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

npmjs rate-limits like any public site. npmjs already paces
...
Where a surface is gated, npmjs reads a cookie or token you supply
...
`npmjs`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what npmjs actually did
